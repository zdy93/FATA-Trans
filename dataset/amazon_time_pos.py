...
class AmazonWithTimePosDataset(AmazonBasicDataset):
    def __init__(self,
                 cls_task,
                 reviewer_ids=None,
                 seq_len=10,
    ...
    def reviewer_level_split_data(self):
        ...
        if self.reviewer_level_cached and path.isfile(fname):
            ...
            for ix in tqdm.tqdm(range(len(start_idx_list))):
                ...
                reviewer_trans, reviewer_label, reviewer_time = [], [], []
    ...
    def prepare_samples(self):
        ...
        if self.get_rids:
            trans_data, trans_labels, trans_rids, trans_time, columns_names = self.reviewer_level_split_data()
        else:
            trans_data, trans_labels, trans_time, columns_names = self.reviewer_level_split_data()
