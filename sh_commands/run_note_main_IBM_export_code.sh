...
if [ "$resample_method" = "None" ]; then
  output_file=out_run_main_ibm_export_${dt}_${resample_method}_${resample_seed}_${seed}.ipynb
  output_dir=../IBM_experiment/${data}/${resample_method}/${dt}/export
else
  output_file=out_run_main_ibm_export_${dt}_${resample_method}_${resample_ratio}_${resample_seed}_${seed}.ipynb
  output_dir=../IBM_experiment/${data}/${resample_method}/${resample_ratio}/${dt}/export
fi

papermill \
run_main_ibm_export.ipynb \
${output_file} \
-k py3.9-visa \
-p data ${data} \
-p dt ${dt} \
