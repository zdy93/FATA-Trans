...
output_file=out_run_main_amazon_pretraining_${dt}_${data}.ipynb
else
output_file=out_run_main_amazon_continue_pretraining_${dt}_${data}.ipynb
fi
output_dir=../IBM_experiment/${data}/${dt}/pretraining


papermill \
run_main_amazon_pretraining.ipynb \
${output_file} \
-k py3.9-visa \
-p data ${data} \
-p dt ${dt} \
