...
output_file=out_run_main_amazon_finetuning_${dt}_${data}.ipynb
else
output_file=out_run_main_amazon_continue_finetuning_${dt}_${data}.ipynb
fi
output_dir=../IBM_experiment/${data}/${dt}/finetuning


papermill \
run_main_amazon_finetuning.ipynb \
${output_file} \
-k py3.9-visa \
-p data ${data} \
-p dt ${dt} \
